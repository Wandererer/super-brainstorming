...
AI-powered brainstorming system that turns one topic into a scored idea portfolio and approved concept briefs — two divergence modes (**creative** thinking-lens divergence, or **research_first**: mine reviews/communities/competitor gaps/trends/market data/existing solutions in parallel and grow every idea from cited evidence), deterministic code-gated convergence, and a built-in handoff to `/insane-research` for evidence-based validation.
